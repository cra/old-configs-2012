...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."h", "WRegion.set_tagged(_sub, 'toggle')", "_sub:non-nil"),
    ...
    bdoc("Grab screenshot."),
    kpress("Print", 'ioncore.exec_on(_, "scrot \'/tmp/screenshot-%F-%R.png\'")'),

    bdoc("Run a terminal emulator."),
    kpress(ALTMETA.."space", "ioncore.exec_on(_, XTERM or 'xterm')"),
    
-- disabled - i want to use win-r
...
--    kpress(ALTMETA.."F3", "mod_query.query_exec(_)"),
    ...
    kpress(META.."F6", 
           "mod_query.query_runfile(_, 'gedit')"),
...
defbindings("WFrame.toplevel", {
    ...
    kpress(META.."e", "mod_query.query_attachclient(_)"),
